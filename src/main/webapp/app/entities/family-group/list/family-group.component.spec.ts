...
import { sampleWithRequiredData } from '../family-group.test-samples';
...
describe('FamilyGroup Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.familyGroups()[0]).toEqual(expect.objectContaining({ id: 28164 }));
  });

  describe('trackId', () => {
    it('should forward to familyGroupService', () => {
      const entity = { id: 28164 };
      jest.spyOn(service, 'getFamilyGroupIdentifier');
      const id = comp.trackId(entity);
      expect(service.getFamilyGroupIdentifier).toHaveBeenCalledWith(entity);
