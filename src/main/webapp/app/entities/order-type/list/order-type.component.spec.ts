...
import { sampleWithRequiredData } from '../order-type.test-samples';
...
describe('OrderType Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.orderTypes()[0]).toEqual(expect.objectContaining({ id: 10129 }));
  });

  describe('trackId', () => {
    it('should forward to orderTypeService', () => {
      const entity = { id: 10129 };
      jest.spyOn(service, 'getOrderTypeIdentifier');
      const id = comp.trackId(entity);
      expect(service.getOrderTypeIdentifier).toHaveBeenCalledWith(entity);
