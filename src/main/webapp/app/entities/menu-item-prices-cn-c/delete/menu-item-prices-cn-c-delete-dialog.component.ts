...
@Component({
  templateUrl: './menu-item-prices-cn-c-delete-dialog.component.html',
  imports: [SharedModule, FormsModule],
})
export class MenuItemPricesCnCDeleteDialogComponent {
  menuItemPricesCnC?: IMenuItemPricesCnC;
  ...
  confirmDelete(id: number): void {
    this.menuItemPricesCnCService.delete(id).subscribe(() => {
