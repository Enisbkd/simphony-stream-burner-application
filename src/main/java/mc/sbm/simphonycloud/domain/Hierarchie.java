...
public class Hierarchie implements Serializable {
    ...
    public Hierarchie nom(String nom) {
        this.setNom(nom);
        return this;
    }
    ...
    public Hierarchie parentHierId(String parentHierId) {
    ...
    public Hierarchie unitId(String unitId) {
    ...
    public boolean equals(Object o) {
        ...
        return getId() != null && getId().equals(((Hierarchie) o).getId());
    }
