...
public class OrganizationLocation implements Serializable {
    ...
    public OrganizationLocation id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public OrganizationLocation orgShortName(String orgShortName) {
    ...
    public OrganizationLocation locRef(String locRef) {
    ...
    public OrganizationLocation name(String name) {
        this.setName(name);
        return this;
    }
    ...
    public OrganizationLocation currency(String currency) {
    ...
    public OrganizationLocation phoneNumber(String phoneNumber) {
    ...
    public OrganizationLocation languages(String languages) {
    ...
    public OrganizationLocation timezoneIanaName(String timezoneIanaName) {
    ...
    public OrganizationLocation timezoneWindowsName(String timezoneWindowsName) {
    ...
    public OrganizationLocation timezoneTzIndex(Integer timezoneTzIndex) {
    ...
    public OrganizationLocation addressLine1(String addressLine1) {
    ...
    public OrganizationLocation addressLine2(String addressLine2) {
    ...
    public OrganizationLocation addressFloor(String addressFloor) {
    ...
    public OrganizationLocation addressLocality(String addressLocality) {
    ...
    public OrganizationLocation addressRegion(String addressRegion) {
    ...
    public OrganizationLocation addressPostalCode(String addressPostalCode) {
    ...
    public OrganizationLocation addressCountry(String addressCountry) {
    ...
    public OrganizationLocation addressNotes(String addressNotes) {
    ...
    public OrganizationLocation geoLatitude(BigDecimal geoLatitude) {
    ...
    public OrganizationLocation geoLongitude(BigDecimal geoLongitude) {
    ...
    public OrganizationLocation posPlatformName(String posPlatformName) {
    ...
    public OrganizationLocation posPlatformVersion(String posPlatformVersion) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OrganizationLocation)) {
            return false;
        }
        return getId() != null && getId().equals(((OrganizationLocation) o).getId());
    }
