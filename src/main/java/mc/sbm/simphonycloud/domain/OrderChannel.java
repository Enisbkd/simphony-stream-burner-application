...
public class OrderChannel implements Serializable {
    ...
    public OrderChannel id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public OrderChannel num(Integer num) {
        this.setNum(num);
        return this;
    }
    ...
    public OrderChannel locRef(String locRef) {
    ...
    public OrderChannel name(String name) {
        this.setName(name);
        return this;
    }
    ...
    public OrderChannel mstrNum(Integer mstrNum) {
    ...
    public OrderChannel mstrName(String mstrName) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OrderChannel)) {
            return false;
        }
        return getId() != null && getId().equals(((OrderChannel) o).getId());
    }
