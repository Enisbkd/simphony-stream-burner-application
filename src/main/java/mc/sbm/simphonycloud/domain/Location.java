...
public class Location implements Serializable {
    ...
    public Location hierUnitId(Integer hierUnitId) {
    ...
    public Location tzIndex(Integer tzIndex) {
    ...
    public Location localeInfoId(Integer localeInfoId) {
    ...
    public Location reportingLocName(String reportingLocName) {
    ...
    public Location locRef(String locRef) {
    ...
    public Location reportingParentEnterpriseLevelName(String reportingParentEnterpriseLevelName) {
    ...
    public Location objectNum(Integer objectNum) {
    ...
    public Location sbmPmsIfcIp(String sbmPmsIfcIp) {
    ...
    public Location sbmPmsIfcPort(String sbmPmsIfcPort) {
    ...
    public Location sbmPriveRoomStart(String sbmPriveRoomStart) {
    ...
    public Location sbmPriveRoomEnd(String sbmPriveRoomEnd) {
    ...
    public Location sbmPmsSendAllDetails(String sbmPmsSendAllDetails) {
    ...
    public Location sbmPmsSendFullDscv(String sbmPmsSendFullDscv) {
    ...
    public Location sbmPmsSend64Tax(String sbmPmsSend64Tax) {
    ...
    public Location sbmCardPaymentUrl(String sbmCardPaymentUrl) {
    ...
    public Location sbmCheckHotelDataUrl(String sbmCheckHotelDataUrl) {
    ...
    public Location sbmVoucherSvcUrl(String sbmVoucherSvcUrl) {
    ...
    public Location sbmVoucherInvPm(String sbmVoucherInvPm) {
    ...
    public Location sbmVoucherCorpPm(String sbmVoucherCorpPm) {
    ...
    public Location sbmVoucherRewardPm(String sbmVoucherRewardPm) {
    ...
    public Location sbmVoucherMcPm(String sbmVoucherMcPm) {
    ...
    public Location sbmPmsIfcPort2(String sbmPmsIfcPort2) {
    ...
    public Location sbmPmsIfcPort3(String sbmPmsIfcPort3) {
    ...
    public Location sbmPmsIfcPort4(String sbmPmsIfcPort4) {
    ...
    public Location sbmTimeout(String sbmTimeout) {
