...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer(javax.cache.configuration.Configuration<Object, Object> jcacheConfiguration) {
        return cm -> {
            ...
            createCache(cm, mc.sbm.simphonycloud.domain.CodeRaisonBI.class.getName(), jcacheConfiguration);
            ...
            createCache(cm, mc.sbm.simphonycloud.domain.FamilyGroupCnC.class.getName(), jcacheConfiguration);
            ...
            createCache(cm, mc.sbm.simphonycloud.domain.HierarchieCnC.class.getName(), jcacheConfiguration);
            createCache(cm, mc.sbm.simphonycloud.domain.HttpCallAudit.class.getName(), jcacheConfiguration);
            createCache(cm, mc.sbm.simphonycloud.domain.LocationCnC.class.getName(), jcacheConfiguration);
            createCache(cm, mc.sbm.simphonycloud.domain.MajorGroupCnC.class.getName(), jcacheConfiguration);
            ...
            createCache(cm, mc.sbm.simphonycloud.domain.OrderChannelBI.class.getName(), jcacheConfiguration);
            createCache(cm, mc.sbm.simphonycloud.domain.OrderTypeBI.class.getName(), jcacheConfiguration);
            createCache(cm, mc.sbm.simphonycloud.domain.OrganizationLocationTrans.class.getName(), jcacheConfiguration);
            ...
            createCache(cm, mc.sbm.simphonycloud.domain.SocieteTrans.class.getName(), jcacheConfiguration);
