...
public class OrderChannelBITestSamples {
    ...
    public static OrderChannelBI getOrderChannelBISample1() {
        return new OrderChannelBI().id(1L).num(1).locRef("locRef1").name("name1").mstrNum(1).mstrName("mstrName1");
    }

    public static OrderChannelBI getOrderChannelBISample2() {
        return new OrderChannelBI().id(2L).num(2).locRef("locRef2").name("name2").mstrNum(2).mstrName("mstrName2");
    }
