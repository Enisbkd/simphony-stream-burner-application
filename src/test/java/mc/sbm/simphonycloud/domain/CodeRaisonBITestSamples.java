...
public class CodeRaisonBITestSamples {
    ...
    public static CodeRaisonBI getCodeRaisonBISample1() {
        return new CodeRaisonBI().id(1L).nomCourt(1).nomMstr("nomMstr1").numMstr(1).name("name1").etablissementRef("etablissementRef1");
    }

    public static CodeRaisonBI getCodeRaisonBISample2() {
        return new CodeRaisonBI().id(2L).nomCourt(2).nomMstr("nomMstr2").numMstr(2).name("name2").etablissementRef("etablissementRef2");
    }
