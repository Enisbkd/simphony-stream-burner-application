...
public class HierarchieCnCTestSamples {
    ...
    public static HierarchieCnC getHierarchieCnCSample1() {
        return new HierarchieCnC().id(1L).nom("nom1").parentHierId("parentHierId1").unitId("unitId1");
    }

    public static HierarchieCnC getHierarchieCnCSample2() {
        return new HierarchieCnC().id(2L).nom("nom2").parentHierId("parentHierId2").unitId("unitId2");
    }
