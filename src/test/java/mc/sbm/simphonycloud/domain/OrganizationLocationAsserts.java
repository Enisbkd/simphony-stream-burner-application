...
public class OrganizationLocationAsserts {
     ...
     */
    public static void assertOrganizationLocationAllPropertiesEquals(OrganizationLocation expected, OrganizationLocation actual) {
        assertOrganizationLocationAutoGeneratedPropertiesEquals(expected, actual);
        assertOrganizationLocationAllUpdatablePropertiesEquals(expected, actual);
    }
     ...
     * @param actual the actual entity
     */
    public static void assertOrganizationLocationAllUpdatablePropertiesEquals(OrganizationLocation expected, OrganizationLocation actual) {
        assertOrganizationLocationUpdatableFieldsEquals(expected, actual);
        assertOrganizationLocationUpdatableRelationshipsEquals(expected, actual);
    }
     ...
     * @param actual the actual entity
     */
    public static void assertOrganizationLocationAutoGeneratedPropertiesEquals(OrganizationLocation expected, OrganizationLocation actual) {
        assertThat(actual)
            .as("Verify OrganizationLocation auto generated properties")
     ...
     * @param actual the actual entity
     */
    public static void assertOrganizationLocationUpdatableFieldsEquals(OrganizationLocation expected, OrganizationLocation actual) {
        assertThat(actual)
            .as("Verify OrganizationLocation relevant properties")
     ...
     * @param actual the actual entity
     */
    public static void assertOrganizationLocationUpdatableRelationshipsEquals(OrganizationLocation expected, OrganizationLocation actual) {
        // empty method
    }
}
