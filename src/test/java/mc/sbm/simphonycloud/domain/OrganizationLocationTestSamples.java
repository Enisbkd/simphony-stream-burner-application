...
public class OrganizationLocationTestSamples {

    private static final Random random = new Random();
    private static final AtomicLong longCount = new AtomicLong(random.nextInt() + (2 * Integer.MAX_VALUE));
    private static final AtomicInteger intCount = new AtomicInteger(random.nextInt() + (2 * Short.MAX_VALUE));

    public static OrganizationLocation getOrganizationLocationSample1() {
    ...
    public static OrganizationLocation getOrganizationLocationSample2() {
        return new OrganizationLocation()
            .id(2L)
    ...
    public static OrganizationLocation getOrganizationLocationRandomSampleGenerator() {
        return new OrganizationLocation()
